 ...
 *Tarih:3.12.21
 * Yazan:Aybüke SÖKMEN
 *AÇIKLAMA:Paket yapýsý ve algoritmasý tamamlandý.
 *ÇÖZÜMLENEMEYENLER: Paket aldim yapýsý,transmit fonksiyonunun konumu
 *
 *
 *
 *
 ...
 *Tarih:14.12.21
 * Yazan:Aybüke SÖKMEN
 *AÇIKLAMA: Paketlerin hepsinin alýnabilmesi için emirboyutu*4 boyutunda bir dizi oluþturuldu.
 *
 *
